...
<div class="row-fluid sortable">
    <div class="card">
        ...
        <div class="card-header">
            <strong>Update Supplier Information</strong> 
        </div>



        <div class="card-body card-block">
            <form action="{{url('/update-supplier/'.$edit->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text"  name="bank_branch" value="{{$edit->bank_branch}}" class="form-control" required>
                    </div>
                </div>
